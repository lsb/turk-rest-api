...
def ship_oldest_batch!(db, endpoint, access_key, secret_access_key, maybe_queue = nil)
  ...
  return if b.nil?
  hits_idquestions = ship_all!(b.fetch('instructions'), b.fetch('questions'), b.fetch('distinctUsers'), b.fetch('addMinutes'), b.fetch('cost'), b.fetch('knownAnswerQuestions'), endpoint, access_key, secret_access_key, maybe_queue)
